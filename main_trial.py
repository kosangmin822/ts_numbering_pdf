...
class PdfAnnotator(QtWidgets.QMainWindow):
    ...
    def _save_pdf_with_labels(self, path):
        ...
        try:
                ...
                for it in sorted(items_on_this_page, key=lambda x: x.no):
                    ...
                    if shape_type == "circle" or shape_type not in ["rectangle", "triangle", "star", "none"]:
                        ...
                        for i in range(5):
                            ...
                            py = y_pt_bot - radius_pt * math.sin(rad)
                    ...
                    c.setFillColor(style.text_color.name())
                    
                    text_width = c.stringWidth(text_str, "Helvetica-Bold", font_size_pt)
                    text_height = font_size_pt * 0.35
            ...
            _log_error(self, "PDF 저장(Vector Overlay) 중 오류 발생", e)
            traceback.print_exc()
